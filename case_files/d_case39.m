...
% Bno   Srat  Vn  fn |mdl typ   xl      ra          xd        xd'     xd''    T'd0  T''d0   xq      x'q    x''q   T'q0  T''q0   M=2H          D   Kw  Kp  gammaP  gammaQ  TAA   S(1.0)  S(1.2)
    39,  2000, 1, 60,    4,    0.003    0          0.02       0.006    1       7      0    0.019    0.008   0      0.7    0     1000.0000     14   0.5   0   1       1       0       0       0;    % G1
    31,  200,  1, 60,    4,    0.035    0          0.295      0.0697   1       6.56   0    0.282    0.17    0      1.5    0     60.6000       14   0.5   0   1       1       0       0       0;    % G2
    32,  200,  1, 60,    4,    0.0304   0          0.2495     0.0531   1       5.7    0    0.237    0.0876  0      1.5    0     71.6000       14   0.5   0   1       1       0       0       0;    % G3
    33,  200,  1, 60,    4,    0.0295   0          0.262      0.0436   1       5.69   0    0.258    0.166   0      1.5    0     57.2000       14   0.5   0   1       1       0       0       0;    % G4
    34,  200,  1, 60,    4,    0.054    0          0.67       0.132    1       5.4    0    0.62     0.166   0      0.44   0     52.0000       14   0.5   0   1       1       0       0       0;    % G5
    35,  200,  1, 60,    4,    0.0224   0          0.254      0.05     1       7.3    0    0.241    0.0814  0      0.4    0     69.6000       14   0.5   0   1       1       0       0       0;    % G6
    36,  200,  1, 60,    4,    0.0322   0          0.295      0.049    1       5.66   0    0.292    0.186   0      1.5    0     52.8000       14   0.5   0   1       1       0       0       0;    % G7
    37,  200,  1, 60,    4,    0.028    0          0.29       0.057    1       6.7    0    0.28     0.0911  0      0.41   0     48.6000       14   0.5   0   1       1       0       0       0;    % G8
    38,  200,  1, 60,    4,    0.0298   0          0.2106     0.057    1       4.79   0    0.205    0.0587  0      1.96   0     69.0000       14   0.5   0   1       1       0       0       0;    % G9
    30,  200,  1, 60,    4,    0.0125   0          0.1        0.031    1       10.2   0    0.069    0.008   0      0      0     84.0000       14   0.5   0   1       1       0       0       0;    % G10  
 ];
% AVR data
 Exc.con = [ ... 
