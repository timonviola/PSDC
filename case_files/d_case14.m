...
% bus no    Srating     Vrating     Pload   Qload   Vmax    Vmin    z   u
  ...
  4         100         69          0.478   -0.3    1.2     0.8     0   1;
  5         100         69          0.76	0.16    1.2     0.8     0   1;
  6         100         13.8        0.112   0.75    1.2     0.8     0   1;
  9         100         13.8        0.295   0.166   1.2     0.8     0   1;
  10        100         13.8        0.9     0.58    1.2     0.8     0   1;
  11        100         13.8        0.35    0.18    1.2     0.8     0   1;
  12        100         13.8        0.61	0.16    1.2     0.8     0   1;
  13        100         13.8        0.135   0.58    1.2     0.8     0   1;
  14        100         13.8        0.149   0.5	    1.2     0.8     0   1;
 ];
% Reduce load
PQ.con(:,5) = PQ.con(:,4).*0.4;
PQ.con(:,5) = PQ.con(:,5).*0.1;
