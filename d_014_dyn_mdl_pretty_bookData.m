% D_014_DYN_MDL_PRETTY_BOOKDATA  IEEE 14 BUS test system - original system
%   data available at:
...
% bus no    Srating     Vrating     Pload   Qload   Vmax    Vmin    z   u
 ...
 % Synchronous Machine Data Format (Syn.con)
Syn.con = [ ... 
...
% Bno Srat  Vn    fn    -     xl        ra      xd        xd'     xd''    T'd0  T''d0   xq      x'q    x''q   T'q0  T''q0   M=2H    D      Kw  Kp  gammaP  gammaQ  TAA   S(1.0)  S(1.2)
  1   615   69    60    5.2   0.2396    0.0031  0.8979    0.2995  0.23    7.4   0.03    0.646   0.646  0.4    0.3   0.033   10.296  0.46   0   0   1       1       0     0       0;
  3   60    69    60    6     0         0.0031  1.05      0.185   0.13    6.1   0.04    0.98    0.36   0.13   0.3   0.099   13.08   0.46   0   0   1       1       0     0       0;
  2   60    69    60    6     0         0.0031  1.05      0.185   0.13    6.1   0.04    0.98    0.36   0.13   0.3   0.099   13.08   0.46   0   0   1       1       0     0       0;
  8   25    18    60    6     0.134     0.0014  1.25      0.232   0.12    4.75  0.06    1.22    0.715  0.12   1.5   0.21    10.12   0.46   0   0   1       1       0     0       0;
  6   25    13.8  60    6     0.134     0.0014  1.25      0.232   0.12    4.75  0.06    1.22    0.715  0.12   1.5   0.21    10.12   0.46   0   0   1       1       0     0       0;
 ];

 % AVR data
Exc.con = [ ... 
% genNo AVR type  VrMax     VrMin   Ka      Ta        Kf        Tf    -     Te      Tr        Ae          Be
  1     2         7.32      0       20      0.02      0.0012    1     1     0.19    0.001     0.0006      0.9;
